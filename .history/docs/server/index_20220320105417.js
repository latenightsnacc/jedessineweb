    ...
    console.log(req.body);
     try{
         if(!req.body ){
             ...
             const recordAttendance = await db.recordattendan(firstname,surname,batch,statecode,cdsGroup,lga,ppa,email,phoneNo,profilePic,password,status,roles,state);

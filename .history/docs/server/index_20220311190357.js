...
//CORPER SIGN UP
app.post("/api/auth/signup",upload.single('profile-file') async (req, res) => {
    try{
        if(!req.body){
        ...
        upload(req, res, function(err) {
            ...
            const newCorper =  db.insertCorper(firstname,surname,batch,statecode,cdsGroup,lga,ppa,email,phoneNo,profilePic,password,status,roles,state).then(corperId => {

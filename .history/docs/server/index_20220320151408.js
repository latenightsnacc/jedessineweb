    ...
    const records = Object.keys(req.body)
     try{
         if(!req.body ){
             ...
             const date = req.body.date_recorded;
             const month = req.body.month_recorded;
             const year = req.body.year_recorded;
             const type = req.body.attend_for;
             const status = req.body.attendance_status;
             const comment = req.body.comt;
             const corperId = req.body.id;

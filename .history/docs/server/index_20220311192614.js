...
app.post("/api/auth/signup",upload.single('profilePic'), async (req, res) => {
    try{
        if(!req.body || !req.file){
            ...
            const insertCorper =db.insertCorper(firstname,surname,batch,statecode,cdsGroup,lga,ppa,email,phoneNo,profilePic,password,status,roles,state).then(corperId => {

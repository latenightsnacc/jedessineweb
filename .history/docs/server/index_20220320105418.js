    ...
    console.log(req.body);
     try{
         if(!req.body ){
             ...
             const date = req.body.firstname;
             const month = req.body.surname;
             const year = req.body.batch;
             ...
             const recordAttendance = await db.recordattendance(firstname,surname,batch,statecode,cdsGroup,lga,ppa,email,phoneNo,profilePic,password,status,roles,state);

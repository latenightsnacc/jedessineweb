    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          />
          <Route path={"/dashboard/secretarygeneral/notes/new"} element={(
            <ProtectedRoute>
              <New />
            </ProtectedRoute>) } 
          />
          <Route path={"/dashboard/secretarygeneral/notes/:noteid"} element={(
            <ProtectedRoute>
              <Minutes/>
            </ProtectedRoute>) } 
          />
          <Route path={"/dashboard/secretarygeneral/attendance/all"} element={(
            <ProtectedRoute>
              <Attendance />
            </ProtectedRoute>) } 
          />
          <Route path={"/dashboard/secretarygeneral/attendance/new"} element={(
            <ProtectedRoute>
              <RecordAttendance />
            </ProtectedRoute>) } 
          />
          <Route path={"/dashboard/secretarygeneral/attendance/weekly"} element={(
            <ProtectedRoute>
              <WeeklyAttendance />
            </ProtectedRoute>) } 
          />
          <Route path={"/dashboard/secretarygeneral/attendance/monthly"} element={(
            <ProtectedRoute>
              <MonthlyAttendance />
            </ProtectedRoute>) } 
          />

...
const getAttendanceFor = (e) => {
    ...
    const trySending = (e) => {
        ...
        console.log(rr);
        try{
            Axios.post("http://localhost:4000/recordattendance", {
                ...rr
            }).then( r => {
                return r;
            })
            ...
            <form onSubmit={trySending}>
                <Container>
                    ...
                    <table className="border-collapse border border-slate-400 table-hover text-xs md:text-sm bg-white rounded">
                        <thead>
                            <tr>
                                <th scope="col" className="text-left border border-slate-400 px-2 py-1">No.</th>
                                <th scope="col" className="text-left border border-slate-400 px-2 py-1 hidden md:table-cell">Name</th>
                                <th scope="col" className="text-left border border-slate-400 px-2 py-1"> Statecode</th>
                                <th scope="col" className="text-left border border-slate-400 px-2 py-1">Batch</th>
                                <th scope="col" className="text-left border border-slate-400 px-2 py-1">
                                ...
                                <th scope="col" className="text-left w-auto border border-slate-400 px-2 py-1">Comment</th>
                            </tr>
                        </thead>
                            ...
                            return (
                                <tr className='text-xs md:text-sm font-medium hover:bg-white hover:text-green-500' id={val.id} key={val.id}>
                                    <td className="text-left text-xs border border-slate-400 px-2 py-1" >
                                    {count++}
                                    </td>
                                    <td className="hidden md:table-cell border border-slate-400 px-2 py-1">
                                    {val.surname} {val.firstname}
                                    </td>
                                    <td className="border border-slate-400 px-2 py-1 uppercase">
                                    {val.statecode}
                                    </td>
                                    <td className="text-left text-xs border border-slate-400 px-2 py-1">
                                    {val.batch}
                                    ...
                                    <td className="text-center border border-slate-400 px-2 py-1">
                                            <input 
                                                type="radio"

...
const Attendance = () => {
    ...
    for(const row of results){
        ...
        switch (m) {
            case 'January': 
            month.jan.records.push(a);
            month.jan.lt = month.jan.length;
            break
            case 'February': 
            month.feb.push(a);
            break
            case 'March': 
            month.mar.records.push(a);
            month.mar.lt = month.mar.length;
            break
            case 'April': 
            month.april.records.push(a);
            month.april.records = month.april.length;
            break
            case 'May': 
            month.may.push(a);
            break

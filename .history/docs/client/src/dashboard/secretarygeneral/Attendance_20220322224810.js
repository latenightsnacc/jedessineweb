    ...
    results.map(x => {
        ...
        switch (x.month) {
            ...
            case 'March': 
                ...
                unique = dates;
                if (dates.size > 0 && x === results.length - 1) {
                    if(unique){
                        mt.mar[0].dates.push(unique);
                    }
                }
            ...
            case 'April':
                ...
                if( mt.april[0][`${x.year}`].records.length > 0){
                    mt.april[0][`${x.year}`].records.map(x => {
                            if(x.status === 'present'){
                                 mt.april[0][`${x.year}`].present += 1;
                            } else if (x.status === 'absent'){
                                 mt.april[0][`${x.year}`].absent += 1;
                            } else {
                                 mt.april[0][`${x.year}`].late += 1;
                             }
                             return x;
                         });
                }
                getAttendanceStatus(mt.april[0][`${x.year}`].records, mt.april[0][`${x.year}`].present, mt.april[0][`${x.year}`].absent, mt.april[0][`${x.year}`].late);
            break;
            case 'May': 
            mt.may.push(x);
            break;

    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Container>
                   <MiniLayout>
                       <div className="w-full md:w-4/6 mx-auto shadow-xl py-3 p-10 text-sm tracking-wider">
                           <div >
                                <span>Wednesday, 22nd March 2022</span>
                                <div className="mt-2">
                                    <div className="my-2">Attendance: <span className="bg-green-300 px-2 py-1 rounded text-white font-semibold">Meeting</span></div>
                                    <div className="">Status: <span>Present</span></div>
                                </div>

...
const ViewAttendance = () => {
    ...
    if (allRoles[1] === "Secretary General"){
        url = 'http://localhost:3000/dashboard/secretarygeneral/';
                    ...
                    <div className="w-full md:w-4/6 mx-auto py-3 px-10 text-sm tracking-wider">
                        <table className="w-full border-collapse border border-slate-400  rounded">
                            ...
                            <tr>
                                ...
                                <td className="text-center font-medium text-gray-800 border border-slate-300">
                                    100
                                </td>
                            ...
                            <tr>
                                <th className="text-left border border-slate-300 font-medium tracking-wider py-1">February</th>
                                <td className="text-center font-medium text-gray-800 border border-slate-300">
                                    100
                                </td>

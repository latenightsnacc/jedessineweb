               ...
               <Container>
                    ...
                    <div className="w-full md:w-4/6 mx-auto py-3 px-10 text-sm tracking-wider">
                        <table className="w-full border-collapse border border-slate-400  rounded">
                            <thead>
                                <tr>
                                    <th scope="col" className="text-left font-medium tracking-wider border border-slate-300 py-1">Dues </th>
                                    <th scope="col" className="text-center border border-slate-300">Amounts</th>

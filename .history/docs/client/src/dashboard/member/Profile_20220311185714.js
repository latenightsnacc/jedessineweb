    ...
    return(
        <>
           ...
           CorperBanner 
                ...
                profilePic={`http://localhost:3000/public_html/images/${user.profilePic}`}
               ...
               <Container>
                    <MiniLayout>
                    <div className={`w-full md:w-4/6 mx-auto ${opacity}`}>
                    ...
                    <input type="button" 
                        value={btnValue}
                        onClick={editProfile}
                        className="w-full  bg-gray-400  text-white p-2 hover:bg-green-500 focus:ring-0 focus:outline-0' hover:shadow-lg"
                        />
                    </div>
                    </MiniLayout>
               </Container>

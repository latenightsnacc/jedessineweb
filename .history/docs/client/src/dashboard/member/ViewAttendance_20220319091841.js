                        ...
                        <table className="w-full border-collapse border border-slate-400  rounded">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" className="text-center border border-slate-300 py-1">1</th>
                                    <th scope="col" className="text-center border border-slate-300 py-1">2</th>
                                    <th scope="col" className="text-center border border-slate-300 py-1">3</th>
                                    <th scope="col" className="text-center border border-slate-300 py-1">4</th>
                                    <th scope="col" className="text-center border border-slate-300 py-1">5</th>
                                    <th scope="col" className="text-center border border-slate-300 py-1">%</th>
                                </tr>
                            </thead>
                            <tbody className="font-light">
                            <tr>
                                <th className="text-left border border-slate-300 font-medium tracking-wider">January</th>

            ...
            <div className="w-3/6 mx-auto bg-white py-10 shadow-lg rounded my-4">
                ...
                <div className="w-3/4 mx-auto">
                    ...
                    <div className=" w-full flex flex-col items-center justify-center">
                        <div className=" w-full flex text-xs items-center justify-center mb-3 tracking-widest"><input type={"checkbox"} className={"checked:bg-green-500"}  />
                        <span className="ml-2 text-green-500">I have cofirmed that my details above are correct.</span></div>

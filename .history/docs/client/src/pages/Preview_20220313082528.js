    ...
    return(
        <Container>
            <div className="w-full max-w-lg mx-auto bg-white shadow-lg rounded my-4">
                ...
                <div>
                    <ul className="text-xs md:text-sm w-full text-green-600 tracking-wide  py-2 px-2 leading-loose font-medium">
                        <li >First name: <span className="text-gray-700">Deborah Egonu</span> </li>

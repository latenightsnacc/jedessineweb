            ...
            <div className="w-full max-w-lg mx-auto bg-white py-10 shadow-lg rounded my-4">
                ...
                <div className="w-3/4 mx-auto">
                    ...
                    <div className=" w-full flex flex-col items-center justify-center">
                        <div className=" w-full flex  items-center justify-center my-1"><input type={"checkbox"}  />
                        <span className="ml-2 ">I have cofirmed that my details above are accurate </span></div>

const Preview = (props) => {
    ...
    return(
        <div className="w-full mx-auto bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4 my-4">
            <div className="w-2/6 mx-auto py-3">
                <img className="rounded-full" src={props.image} alt={props.altText} />
            </div>
            <p className="text-center text-xs text-red-500 font-medium mb-10">Please confirm that your details are all correct.</p>

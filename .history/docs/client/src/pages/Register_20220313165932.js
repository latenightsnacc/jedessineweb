            ...
            <div className="w-full max-w-lg">
              <form className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                  <div className="mb-4">
                    <div className={`relative group py-2 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400`}>
                        <div className="absolute -top-3">
                            <label className="inline px-2 bg-white text-gray-00 group-hover:text-green-500 text-xs font-normal tracking-widest">
                                First Name
                            </label>
                        </div>
                        <input 
                        ...
                        className={'border-0 text-xs md:text-sm w-full text-gray-00  py-2 px-2 leading-loose font-normal tracking-widest focus:ring-0 focus:outline-0 text-uppercase'}
                        placeholder={'Deborah'}
                ...
                <div className="relative group py-2 mb-4 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400">
                    ...
                    name={'batch'}
                    value={corper.batch}
                    className={'border-0 text-xs md:text-sm w-full text-gray-00  py-2 px-2 leading-loose font-normal tracking-widest focus:ring-0 focus:outline-0 uppercase'}
                    placeholder={'2021 A'}
                    onChange={handleInputChange}
                     />
                </div>

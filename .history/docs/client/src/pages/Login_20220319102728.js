            ...
            <div className="flex h-screen flex-col items-center justify-center tracking-widest">
                ...
                <div  className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <div className="relative group py-2 mb-6 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400">
                        ...
                        <label className="inline px-2 bg-white text-gray-700 group-hover:text-green-500 text-xs font-normal">
                            Email
                        </label>
                        </div>
                        <input 
                        ...
                        className={'border-0 text-xs tracking-widest md:text-sm w-full text-gray-700  py-2 px-2 leading-loose font-medium focus:ring-0 focus:outline-0 text-uppercase'}
                    ...
                    <div className="relative group py-2 mb-4 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400">
                        <div className="absolute -top-3">
                        <label className="inline px-2 bg-white text-gray-700 group-hover:text-green-500 text-xs font-normal capitalize">
                            password
                        </label>
                        </div>
                        <input 
                    ...
                    className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" >Login</button>
                    ...
                    <span className="inline-block mt-2 align-baseline  text-gray-500  text-center">
                        ...
                        <Link to={"/api/auth/signup"}>
                            <span className="text-green-400 mml-1 cursor-pointer text-underline font-medium">Create</span>
                        </Link>
                    </span>
                    <span className="inline-block mt-2 ml-3 align-baseline text-gray-500 hover:text-green-500 text-center">
                        Forgot Password?
                    </span>
                    </div>
                </div>

            ...
            <div className="w-3/6 mx-auto bg-white py-10 shadow-lg rounded my-4">
                ...
                <div className="w-3/4 mx-auto">
                    <ul className="text-xs text-center w-full md:text-sm w-full text-green-600 tracking-widest  pt-2 pb-4 px-2 leading-10 ">
                        ...
                        <li >Surname: <span className="text-gray-700 font-medium leading-10">{props.firstname}</span> </li>
                        <li >Batch: <span className="text-gray-700 font-medium leading-10">{props.firstname}</span> </li>
                        <li >L.G.A: <span className="text-gray-700 font-medium leading-10">{props.firstname}</span> </li>
                        ...
                        <li > C.D.S Group: <span className="text-gray-700 font-medium leading-10">{props.firstname} (ICT)</span> </li>

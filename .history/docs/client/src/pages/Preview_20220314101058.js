            ...
            <div className="w-3/4 mx-auto tracking-widest">
                ...
                <div className={`w-full flex flex-col items-center justify-center tracking-widest `}>
                    ...
                    <button 
                        ...
                        type="submit"
                        className="bg-green-500 block w-dulhover:bg-green-700 text-white font-bold py-2 px-4 mt-4 rounded focus:outline-none focus:shadow-outline tracking-widest">
                        Create Profile
                        </button>
                </div>

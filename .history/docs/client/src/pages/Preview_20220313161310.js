...
const Preview = () => {
    return(
        <Container>
            <div className="w-full max-w-lg mx-auto bg-white py-10 shadow-lg rounded-LG my-4">
                <div className="text-center  mb-6">
                    <span className="text-green-500 font-semibold capitalize">CDS E-attendance</span>
                    <h1 className="text-black font-medium leading-loose text-xl uppercase tracking-wide">CREATE PROFILE - PREVIEW</h1>
                    <span></span>
                </div>

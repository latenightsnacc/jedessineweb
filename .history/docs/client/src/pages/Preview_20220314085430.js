                ...
                <div className="w-3/4 mx-auto">
                    ...
                    <div className="mb-1 text-red-400 text-xs font-medium">
                        ...
                        <div className=" w-full flex text-xs items-center justify-center tracking-widest">
                            ...
                            <span className="ml-2 text-sm">I have cofirmed that my details above are correct.<br/>I understand that I cannot edit the details above once submitted.</span>
                        </div>

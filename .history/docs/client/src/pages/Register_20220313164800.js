            ...
            <div className="w-full max-w-lg">
              <form className="bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4">
                  <div className="mb-4">
                    <div className={`relative group py-2 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400`}>
                        <div className="absolute -top-3">
                            <label className="inline px-2 bg-white text-gray-700 group-hover:text-green-500 text-xs font-">
                                First Name
                            </label>
                        </div>
                        <input 
                        ...
                        className={'border-0 text-xs md:text-sm w-full text-gray-700  py-2 px-2 leading-loose font- focus:ring-0 focus:outline-0 text-uppercase'}
                        placeholder={'Deborah'}
                ...
                <div className="relative group py-2 mb-4 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400">
                    ...
                    name={'batch'}
                    value={corper.batch}
                    className={'border-0 text-xs md:text-sm w-full text-gray-700  py-2 px-2 leading-loose font- focus:ring-0 focus:outline-0 uppercase'}
                    placeholder={'2021 A'}
                    onChange={handleInputChange}
                     />
                </div>
                ...
                <div className="flex w-full flex-col">
                  ...
                  type="submit"
                  className="bg-green-500 hover:bg-green-700 text-white font- py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                   Create Profile
                  </button>
                  ...
                  <div className="inline-block mt-2 align-baseline text-xs md:text-sm text-gray-500  text-center">
                    ...
                    <Link to={"/api/auth/signin"}>
                        <span className="text-green-400 ml-1 cursor-pointer text-underline font-">Login</span>
                    </Link>

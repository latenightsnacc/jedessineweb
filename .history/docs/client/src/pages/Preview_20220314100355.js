    ...
    return(
        <div className="w-full mx-auto bg-white py-10 shadow-lg rounded my-4">
                ...
                <div className="w-3/4 mx-auto">
                    <div className={`relative group py-2 rounded text-sm w-full shadow-sm border border-1 border-gray-300  appearance-none rounded focus:outline-none focus:shadow-outline focus:border hover:border-2 hover:border-green-400 my-2`}>

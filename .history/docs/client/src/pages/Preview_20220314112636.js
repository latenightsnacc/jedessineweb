        ...
        <div className="w-full mx-auto bg-white sm:shadow-md rounded px-8 pt-6 pb-8 mb-4 my-4">
            ...
            <div className="w-3/4 mx-auto tracking-widest">
                ...
                <div className={`w-full flex flex-col items-center justify-center tracking-widest `}>
                    <button onClick={props.backBtn} className="text-sm text-left block mt-3 w-full text-red-500 tracking-widest"><span className="mr-2"><i class="fa-solid fa-arrow-left-long"></i></span> I made an error, go back.</button>

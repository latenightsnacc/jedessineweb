    ...
    return(
        <div className="w-full mx-auto bg-white py-10 shadow-lg rounded my-4">
            ...
            <div className="w-3/4 mx-auto tracking-widest">
                <div className={`relative group py-2 rounded text-sm w-full shadow-sm border border-1 border-white  appearance-none rounded my-2`}>
                ...
                <div className={`relative group py-2 rounded text-sm w-full shadow-sm border border-1 border-  appearance-none rounded my-2`}>
                <div className="absolute -top-3">
                    <label className="inline px-2 bg-white text-green-500 text-xs font-normal tracking-widest">
                        Surname
                    </label>
                ...
                <div className={`w-full flex flex-col items-center justify-center tracking-widest `}>
                    ...
                    <div className=" w-full flex text-xs items-start justify-center ">

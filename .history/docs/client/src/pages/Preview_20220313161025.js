...
const Preview = () => {
    return(
        <Container>
            <div className="w-full max-w-lg mx-auto bg-gray-50 py-10 shadow-lg rounded my-4">
                ...
                <div className="w-3/4 mx-auto">
                    <ul className="text-xs text-center w-full md:text-sm w-full text-green-600 tracking-wide  pt-2 pb-4 px-2 leading-7 ">
                        ...
                        <li >Email: <span className="text-gray-700 font-medium">deborah.o.egnu@gmail.com</span> </li>

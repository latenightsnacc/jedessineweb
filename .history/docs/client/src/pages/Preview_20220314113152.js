const Preview = (props) => {
    ...
    return(
        <div className="w-full mx-auto bg-white sm:shadow-md rounded px-4 pt-6 pb-8 mb-4 my-4">
            <div className="w-2/6 mx-auto py-3">
                <img className="rounded-full" src={props.image} alt={props.altText} />
            </div>
            <p className="text-center text-xs text-red-500 font-medium mb-10">Please confirm that all your details are 100% correct.</p>
            <div className="w-3/4 mx-auto tracking-widest">
                ...
                <div className={`w-full flex flex-col items-center justify-center tracking-widest `}>
                    <button onClick={props.backBtn} className="text-xs md:text-sm text-left block mt-3 w-full text-red-500 tracking-widest"><span className="mr-2"><i class="fa-solid fa-arrow-left-long"></i></span> I made an error, go back.</button>
                    <div className={`my-2 text-red-400 text-xs font-medium ${props.alertDisplay}`}>
                        <span>Please confirm by checking the box below!</span>
                    </div>
                    <div>
                        <div className=" w-full flex text-xs md:text-sm items-center justify-start mt-2">

const DuesNotification = (props) => {
    return(
        <div className="w-full md:w-4/6 mx-auto shadow rounded py-3 p-10 text-sm tracking-wider my-3">
            ...
            <div className="mt-2">
                <div className="my-2">Dues: <span className="text-gray-800 font-semibold">{props.title}</span></div>
                <div className="mt-">Dues: <span className="text-gray-800 font-semibold">{props.title}</span></div>

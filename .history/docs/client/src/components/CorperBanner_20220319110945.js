    ...
    return(
        <Container>
            <div className="flex flex-row items-center justify-center">
                <div className="w-2/6 lg:w-1/6 px-1">
                    <img 
                ...
                <div className="ml-5 md:ml-10 tracking-wider">
                    <h1 className="leading-7 font-medium text-sm md:text-2xl mb-1">Hello, {props.firstname} </h1>
                    <div className="flex flex-col text-gray-700 text-xs sm:text-sm lg:text-base">
                        ...
                        <div className="mb-1 font-medium text-gray-300">
                            ...
                            <Link to={props.link}>
                            <span className="ml-1 text-green-500 underline cursor-pointer">{props.excoRole}</span>
                            </Link>

...
let count = 1;
    return (
        <table className="border-collapse border border-slate-400  rounded table-hover text-xs md:text-sm bg-white rounded">
                    <thead>
                            <tr className="h-8">
                    ...
                    <tbody>
                        {list.map(val => {
                            return (
                                <tr className='border-collapse border border-slate-400  rounded odd:bg-white even:bg-slate-100 hover:bg-white hover:text-green-500' key={val.id}>
                                    <td>{count++}</td>
                                    <td>

    ...
    const login = async () => {
        ...
        if (result.data.message) {
            ...
            setUser({
                ...
                cdsGroup: result.data.statecode,
                lga: result.data.firstname,
                ppa: result.data.firstname,
                email: result.data.firstname,
                phoneNo: result.data.firstname,
                profilePic: result.data.firstname,
                roles: ['Member', 'Secretary General'],
            });
